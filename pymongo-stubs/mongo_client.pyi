...
from pymongo.write_concern import DEFAULT_WRITE_CONCERN as DEFAULT_WRITE_CONCERN, WriteConcern
...
class MongoClient(common.BaseObject):
    ...
    def close_cursor(self, cursor_id: int, address: Optional[Any] = ...) -> None: ...
    def kill_cursors(self, cursor_ids: List[int], address: Optional[Any] = ...) -> None: ...
