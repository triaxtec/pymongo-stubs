...
class BulkUpsertOperation:
    ...
    def update_one(self, update: Any) -> None: ...
    def update(self, update: Any) -> None: ...
    def replace_one(self, replacement: Any) -> None: ...
...
class BulkOperationBuilder:
    def __init__(self, collection: Any, ordered: bool = ..., bypass_document_validation: bool = ...) -> None: ...
    def find(self, selector: Any, collation: Optional[Any] = ...): ...
